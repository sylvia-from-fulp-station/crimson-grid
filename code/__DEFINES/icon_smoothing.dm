...
#define SMOOTH_GROUP_CITY_WALL S_TURF(70) ///turf/closed/wall/vampwall
...
#define SMOOTH_GROUP_POLICE_TAPE S_OBJ(93) // /obj/structure/holosign/barrier/police_tape // DARKPACK EDIT ADD - Police tape
